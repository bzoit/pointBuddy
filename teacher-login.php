    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" id="tuser" name="username" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
                <span class="uerror"><?php echo $username_err; ?></span>
            </div>
            <div class="form-group">
                <label class="plabel">Password:</label>
                <input type="password" id="tpass" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>">
